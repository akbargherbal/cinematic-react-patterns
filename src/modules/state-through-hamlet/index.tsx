...
export default function StateThroughHamlet(): JSX.Element {
  ...
  const chapters: Chapter[] = [
    ...
    },
    {
      ...
      content:
        "Watching Claudius panic, Hamlet's internal state flips from suspicion to certainty. This **internal setState call** triggers an **automatic re-render**: new purposeful behavior. The change within commands the change without.",
    },
    {
            ...
            <div className="sticky top-24 space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="rounded bg-slate-800/30 p-3">
                        ...
                        <div
                          className={`font-mono text-sm ${isPlaying ? "text-amber-400" : "text-slate-400"}`}
                        >
              ...
              <div className="rounded-xl border border-cyan-500/30 bg-cyan-950/20 p-4">
                ...
                <p className="text-sm text-cyan-200/80">
                  {chapter === 0 &&
                    "State is internal, mutable data that defines a component's current condition and drives its logic."}
                  {chapter === 1 &&
                    "Stale state (incorrect closures) causes buggy re-renders—the component renders broken UI."}
                  {chapter === 2 &&
                    "Calling setState triggers an automatic re-render—the UI updates to reflect the new state."}
                  {chapter === 3 &&
                    "Active state management (internal updates) beats passive reception (external overwrites)."}
                  {chapter === 4 &&
                    "State is your component's engine—its capacity to change, respond, and be interactive."}
                </p>
              </div>
            ...
            {chapter === 0 && (
              <div className="space-y-6">
                <div className="grid gap-6 lg:grid-cols-2">
                  <div className="space-y-4">
                    <div>
                      <h4 className="pb-2 text-center font-bold text-slate-400">
                        Static Portrait
                      </h4>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="pb-2 text-center font-bold text-cyan-300">
                        Dynamic Hamlet
                      </h4>
                ...
                <CodeComparison
                  badCode={staticComponent}
                  goodCode={statefulComponent}
                  language="tsx"
                  themeColor="cyan"
                  badLabel="❌ Static Component"
                  goodLabel="✅ Stateful Component"
                />
              </div>
            )}
              ...
              <div className="space-y-6">
                <div className="rounded-lg border border-slate-700 bg-slate-900/50 p-6">
                  <div className="mb-4 grid grid-cols-2 gap-4">
                    <div
                      className={`rounded p-4 ${demoMode === "broken" ? "border border-red-700/50 bg-red-950/40" : "border border-cyan-700/50 bg-cyan-950/40"}`}
                    >
                  ...
                  <button
                    ...
                    disabled={isPlaying}
                    className={`w-full rounded px-4 py-3 font-bold transition-colors ${isPlaying ? "cursor-not-allowed bg-slate-800" : "bg-red-700 hover:bg-red-600"}`}
                  >
              ...
              <div className="space-y-6">
                <div className="rounded-lg border border-slate-700 bg-slate-900/50 p-6">
                  ...
                  <div className="mb-4 flex items-center justify-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-400">
                        Watch King Claudius's reaction
                      </div>
                    </div>
                  </div>

                  {/* Before/After - keep as grid but more compact */}
                  <div className="mb-4 grid grid-cols-2 gap-3">
                    <div className="flex items-center gap-3 rounded bg-slate-800/30 p-3">
                      <div
                        className={`text-2xl ${certainty === "low" ? "text-amber-400" : "text-slate-500"}`}
                      >
                        {certainty === "low" ? "🤔" : "✅"}
                      </div>
                      <div>
                        <div className="text-xs text-slate-500">Before</div>
                        <div className="text-sm">Suspicion</div>
                      </div>
                    </div>

                    <div className="flex items-center gap-3 rounded bg-cyan-950/30 p-3">
                      <div
                        className={`text-2xl ${certainty === "absolute" ? "text-cyan-400" : "text-slate-500"}`}
                      >
                        {certainty === "absolute" ? "🎯" : "❓"}
                      </div>
                      <div>
                        <div className="text-xs text-cyan-400">After</div>
                        <div className="text-sm">Certainty</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`w-full rounded px-4 py-3 font-bold transition-colors ${certainty === "absolute" ? "cursor-not-allowed bg-slate-800" : "bg-cyan-700 hover:bg-cyan-600"}`}
                  >
                    {certainty === "absolute"
                      ? "Clarity Achieved"
                      : "Observe Guilt (Trigger setState)"}
                  </button>

                  {/* Result - stacked is fine here */}
                  {certainty === "absolute" && (
                    <div className="mt-3 animate-pulse rounded border border-cyan-500/50 bg-cyan-950/30 p-3 text-center">
                      <div className="font-bold text-cyan-300">
                        Re-render Triggered!
                      </div>
                      <div className="mt-1 text-sm text-cyan-200/70">
                        New action: "I'll take the ghost's word for a thousand
                        pound"
                      </div>
                    </div>
                  )}
  ...
  console.log("Now I'll confront my mother");
            ...
            {chapter === 3 && (
              <div className="space-y-6">
                <div className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-slate-700 bg-slate-900/50 p-6">
                    <h4 className="mb-4 text-center font-bold text-slate-400">
                      Passive State
                    </h4>
                  ...
                  <div className="rounded-lg border border-cyan-500/30 bg-cyan-950/20 p-6">
                    <h4 className="mb-4 text-center font-bold text-cyan-300">
                      Active State
                    </h4>
                ...
                <CodeComparison
                  badCode={passiveStateCode}
                  goodCode={activeStateCode}
                  language="tsx"
                  themeColor="cyan"
                  badLabel="❌ Passive State Suffering"
                  goodLabel="✅ Active State Management"
                />
              </div>
            )}
                ...
                <div className="rounded-lg border border-cyan-500/20 bg-gradient-to-br from-slate-900/50 to-cyan-950/20 p-8">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="mb-6 max-w-md text-slate-300">
                      The skull's weight is no longer a burden—it's the heft of
                      potential. Your component's{" "}
