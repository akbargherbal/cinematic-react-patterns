    ...
    <div className="min-h-screen bg-slate-950 font-sans text-slate-300">
      <header className="sticky top-0 z-10 border-b border-red-500/30 bg-slate-950/80 backdrop-blur-sm">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="mb-2 text-3xl font-bold text-red-500 sm:text-4xl">
            A Clockwork Orange
          </h1>
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-20 border-t border-red-500/30 bg-slate-900/95 backdrop-blur-sm">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <button
              onClick={handlePrevious}
              disabled={chapter === 0}
              className="rounded-lg bg-red-600 px-6 py-2 text-white transition-colors hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-30"
    ...
    <div className="rounded-lg border border-slate-800 bg-slate-900/50 p-6">
      ...
      <div className="space-y-4">
        <div className="rounded bg-slate-800/50 p-4">
          <div className="mb-2 text-xs text-slate-500">Internal State:</div>
        ...
        <div className="rounded bg-slate-800/50 p-4">
          <div className="mb-2 text-xs text-slate-500">Render Output:</div>
          <div className="text-slate-300">
            {state.violent ? (
              <span className="text-red-400">
                ⚡ Ultra-violence mode active
              </span>
            ) : (
        ...
        <button
          ...
          className="w-full rounded bg-slate-700 px-4 py-2 text-slate-200 transition-colors hover:bg-slate-600"
        >
...
function LudovicoIntroDemo() {
  ...
  render() {
    ...
    return <div>Appears peaceful</div>;
        ...
        <div className="rounded bg-slate-800/50 p-4">
          <div className="mb-2 text-xs text-slate-500">The Problem:</div>
    ...
    <div className="rounded-lg border border-slate-800 bg-slate-900/50 p-6">
      ...
      <div className="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div className="mb-3 font-mono text-xs text-slate-300">
            violent: {ludovicoState.violent.toString()}
          </div>
          <div className="mb-2 text-xs text-slate-500">Render:</div>
          ...
          <button
            ...
            className="mt-3 w-full rounded bg-red-600 px-3 py-1.5 text-sm text-white transition-colors hover:bg-red-700"
          >
            Apply Ludovico (forceUpdate)
          </button>
        </div>

        <div className="rounded-lg border border-green-500/30 bg-slate-800/30 p-4">
          ...
          <button
            ...
            className="mt-3 w-full rounded bg-green-600 px-3 py-1.5 text-sm text-white transition-colors hover:bg-green-700"
          >
    ...
    <div className="rounded-lg border border-slate-800 bg-slate-900/50 p-6">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          {mismatch && (
            <div className="flex items-start gap-2 rounded border border-red-500/50 bg-red-950/30 p-3 text-sm text-red-400">
        ...
        <div className="flex gap-2">
          <button
            onClick={applyLudovico}
            disabled={mismatch}
            className="flex-1 rounded bg-red-600 px-4 py-2 text-white transition-colors hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-30"
          >
            Apply Ludovico
          </button>
          <button
            onClick={revert}
            disabled={!mismatch}
            className="flex-1 rounded bg-slate-700 px-4 py-2 text-slate-200 transition-colors hover:bg-slate-600 disabled:cursor-not-allowed disabled:opacity-30"
          >
...
// Errors on normal interactions`}
          ...
          <div className="rounded-lg border border-green-500/30 bg-green-950/20 p-4">
            <div className="mb-3 text-sm font-semibold text-green-400">
